...
const Mint = () => {
    return (
        <>
            <Header />
            <main>
                <section className="py-24 bg-primary hidden">
                ...
                <section className="py-24 bg-primary text-center text-white">
                    <h1 className="text-8xl font-bold pb-20">MINT EGGYS</h1>
                    <h2 className="text-5xl leading-normal">Minting coming soon!<br/> Check Discord for updates</h2>
                </section>
            </main>
            <Footer />
        </>
